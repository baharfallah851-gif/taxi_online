...
@section('content')
    <div class="col-12 grid-margin">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title text-center title driver-title">Add Driver</h4><br>
                <form method="post" action="{{route('driver.save')}}" class="form-sample" enctype="multipart/form-data">   {{--enctype = فایل ها هم همراه متن ها بفرست--}}
                    @csrf
                    <div class="row">             {{-- 1 --}}
                        <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <button type="submit" class="btn btn-success" style="margin-top: 30px">Add Driver</button>
                    </div>
                </form>
            </div>
        </div>
